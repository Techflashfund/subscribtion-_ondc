...
class InitService {
    ...
    static async makeInitRequest(payload) {
        try {
            console.log('Making init request with payload:', JSON.stringify(payload, null, 2));
            ...
            console.error('Init request failed:', error);
            throw error;
        }
    }
}
